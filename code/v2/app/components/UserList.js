...
class UserList extends Component {
            ...
            <Container>
                ...
                <Modal
                    ...
                    <View>
                        ...
                        <LocationList onSelectLocation={this.onModalChange(flag, type)}/>
                    </View>
                </Modal>
            </Container>
        );
    ...
    getUserList(location){
        console.log(location, this.state.bloodGroup)
        filterUserList(location, this.state.bloodType).then(res => {
            console.log(res);
